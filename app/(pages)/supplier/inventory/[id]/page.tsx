// File: app/supplier/inventory/[id]/page.tsx
...
// Component ka naam badalna achhi practice hai
export default function SupplierViewJewelryPage() {
  ...
  if (singleStatus === "failed" || !selectedItem) {
    return (
      <div className="container mx-auto py-12 px-4 text-center">
        ...
        {/* === CHANGE 1: Back button ka link supplier inventory par karein === */}
      ...
      <div className="flex items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-4">
          <Button
            ...
            variant="outline"
            size="icon"
            // === CHANGE 2: Back button ka link supplier inventory par karein ===
        ...
        {/* === CHANGE 3: Edit button ka link supplier edit page par karein === */}
        <Button
          onClick={() => router.push(`/supplier/inventory/edit/${itemId}`)}
        >
