// File: app/supplier/inventory/edit/[id]/page.tsx
...
// Sonner ya react-toastify, jo aap use kar rahe hain
import { toast } from "sonner"; // Ya "react-toastify" se import karein
...
export default function SupplierEditJewelryPage() {
  ...
  useEffect(() => {
    if (actionStatus === "succeeded") {
      ...
      // === SIRF YAHAN CHANGE KARNA HAI ===
      router.push(`/supplier/inventory`); // Save hone ke baad supplier inventory par redirect karein
    }
  ...
  if (
    ...
    return (
      <div className="container mx-auto py-12 px-4 text-center">
        ...
        <Button onClick={() => router.push("/supplier/inventory")}>
          <ArrowLeft className="mr-2 h-4 w-4" /> Back to My Inventory
        </Button>
      </div>
    );
  }

  // --- Neeche ka poora JSX code bina kisi change ke copy kar sakte hain ---
  return (
