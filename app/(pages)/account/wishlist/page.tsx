...
import { moveFromWishlistToCart } from "@/lib/features/cart/cartSlice"; // ✅ Sahi slice se import
...
export default function UserWishlistPage() {
  ...
  useEffect(() => {
    // Sirf 'idle' state mein hi fetch karein, taaki baar baar na ho
    if (listStatus === "idle") {
  ...
  const handleAddToCart = (diamondId: string) => {
    // ✅ 'moveFromWishlistToCart' action ko call karein
