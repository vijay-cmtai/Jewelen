      ...
      <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-1 flex flex-col justify-center">
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            Handpicked jewelry and accessories perfect for little ones.
          </p>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-gray-900 text-white px-8 py-4 rounded-full font-semibold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl active:scale-95 w-fit group"
          >
        ...
        <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-4">
          {grid.map((src, idx) => (
            <a key={idx} href="/collections/kids" className="group relative">
